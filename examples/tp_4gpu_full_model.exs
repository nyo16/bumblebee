# Run full Mistral/TinyLlama model on 4 GPUs with tensor parallelism
#
...
#
# Usage:
#   mix run examples/tp_4gpu_full_model.exs
#
# For faster testing:
#   MODEL=tiny LAYERS=4 mix run examples/tp_4gpu_full_model.exs

Nx.default_backend(EXLA.Backend)

IO.puts("=" |> String.duplicate(70))
IO.puts("4-GPU Tensor Parallel Full Model")
IO.puts("=" |> String.duplicate(70))
...
Successfully ran #{num_layers}-layer #{model_name} with 4-GPU tensor parallelism!
...
To run with more layers:
  LAYERS=#{total_layers} mix run examples/tp_4gpu_full_model.exs
""")
