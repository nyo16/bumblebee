defmodule Bumblebee do
  ...
  @transformers_class_to_model %{
    ...
    "Gemma3TextModel" => {Bumblebee.Text.EmbeddingGemma, :base},
    "EmbeddingGemmaModel" => {Bumblebee.Text.EmbeddingGemma, :base},
    "EmbeddingGemmaForTextEmbedding" => {Bumblebee.Text.EmbeddingGemma, :for_text_embedding},
